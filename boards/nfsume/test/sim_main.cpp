...
#define result_tdata    sim->v->eth0_top->axi_10g_ethernet_0_ins->s_axis_tx_tdata
#define result_tkeep    sim->v->eth0_top->axi_10g_ethernet_0_ins->s_axis_tx_tkeep
#define result_tlast    sim->v->eth0_top->axi_10g_ethernet_0_ins->s_axis_tx_tlast
#define result_tvalid   sim->v->eth0_top->axi_10g_ethernet_0_ins->s_axis_tx_tvalid
